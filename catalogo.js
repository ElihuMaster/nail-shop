const infProducto = document.querySelector('.row')
...
infProducto.addEventListener('click', (e) => { //importante con esto solo detectamos una sola vez el boton sin necesidad de estar capturando cada boton individualmente
    addCarrito(e)
})
